...
extern "C" {
  ...
  extern struct rc_option PinSPA_opts[];
...
static struct rc_option vPinSPA_opts[] = {
	// VPinSPA options
...
#if defined(VPINMAME_ALTSOUND) || defined(VPinSPA_PINSOUND)
	{ "sound_mode", NULL, rc_int, &sound_mode, "0", 0, 3, NULL, "Sound processing mode (PinSPA, Alternative, PinSound, PinSound + Recordings)" },
#endif
...
static struct rc_option opts[] = {
	...
	{ NULL, NULL, rc_link, PinSPA_opts, NULL, 0,	0, NULL, NULL },
	{ NULL, NULL, rc_link, vPinSPA_opts, NULL, 0,	0, NULL, NULL },
	{ NULL,	NULL, rc_end, NULL, NULL, 0, 0,	NULL, NULL }
};
...
#if (!defined(PINMAME) || defined(MAME_DEBUG) || defined(_DEBUG)) // In PinSPA, log only in debug mode.
