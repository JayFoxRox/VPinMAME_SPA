// VPinSPA.cpp : Implementation of DLL Exports.
...
//
//      Modify the custom build rule for PinSPA.idl by adding the following
//      files to the Outputs.
//          PinSPA_p.c
//          dlldata.c
//      To build a separate proxy/stub DLL,
//      run nmake -f PinSPAps.mk in the project directory.
#include "stdafx.h"
#include "resource.h"
#include <initguid.h>
#include "VPinSPA_h.h"
...
BOOL WINAPI DllMain(HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved)
{
    ...
    {
        _Module.Init(ObjectMap, hInstance, &LIBID_VPinSPALib);
...
/*
	if ( !IsSingleThreadedApartment() ) {
		MessageBox(0, "Wrong threading model, please reinstall VPinSPA!", "Unable to run", MB_ICONINFORMATION|MB_OK);
		return CLASS_E_CLASSNOTAVAILABLE;
	}
*/
