 ...
 *
 *   Modifications for PinSPA by Steve Ellenoff & Martin Adrian & Carsten Waechter
 *
...
#if 0//def PinSPA // different shifts to 'simulate' external amplifiers and other hardware
