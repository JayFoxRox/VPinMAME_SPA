...
{
#ifdef PINMAME
        printf("PinSPA is an emulator: it reproduces, more or less faithfully, the behaviour\n"
               ...
               "say, ROMs are not distributed together with PinSPA. Distribution of PinSPA\n"
...
#ifdef VPINMAME
	if ( (!g_fMechSamples) && _stricmp(*samplenames, "*PinSPA")==0 )
		return samples;
#endif
