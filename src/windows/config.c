...
struct rc_option PinSPA_opts[] = {
        /* PinSPA options */
        { "PinSPA options", NULL, rc_seperator, NULL, NULL, 0, 0, NULL, NULL },
#ifdef VPINMAME
        ...
        { "sound_mode", NULL, rc_int, &pmoptions.sound_mode, "0", 0, 3, NULL, "Sound processing mode (PinSPA, Alternative, PinSound, PinSound + Recordings)" },
#endif
#ifdef PROC_SUPPORT
